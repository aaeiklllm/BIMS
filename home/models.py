...
class RS_Step4(models.Model):
    ...
    interval = models.CharField(max_length=300, blank=True)
    ...
    start_date_yyyy = models.CharField(max_length=4, blank=True, null=True)  # e.g., "2024"
...
class RS_Step5(models.Model):
    ...
    collection_date_yyyy = models.CharField(max_length=4, blank=True, null=True)  # e.g., "2024"
